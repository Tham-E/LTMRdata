...
rm(Sample,sampleSTN,Length,Length_measured,STNTables,TowEffort,count_mismatch,fish_adjustedCount,fish_totalCatch,Web_Local_Meter_Corrections,luStation,luTide,luTowDirection,Catch)
